...
const Orders = () => {
  ...
  //     await axios
  //       .get('http://localhost:3001/admin/careers', {
  //         params: {
  //           page,
  //         },
  //       })
  //       .then(({ data }) => {
  //         // console.log('Fetched!', data, page, data.totalPages);
  //         if (data) {
  ...
  //             console.log(`new page count: `, prevPageCount++, totalPages, data.totalPages);
  //             if (prevPageCount > fetchedTotalPages) {
  //               setIsFetching(null);
  //               setBottomText('All orders loaded');
  //             }
  ...
  //         } else {
  //           // Handle the case where data or data.data is not as expected
  ...
  //         setIsFetching(false);
  //         setBottomText('Scroll down for more');
  //         console.error(`There has been an error while loading orders data`, err);
  //       })
  //       .finally(() => {});
  //   };
  ...
  //   const [isFetching, setIsFetching] = React.useState<boolean | null>(true);
  //   const [bottomText, setBottomText] = React.useState('Scroll down for more');
  ...
  //     console.log('began fetching via scroll');
  //     fetch();
  ...
  //   const handleSearchValueChange = (e: any) => setSearchQuery(e.target.value);

  //   const handleSearch = () => {
  //     if (!searchQuery) return router.push('/orders');
  ...
  //       setType('all');
  //       return setSearchQuery(search.toString());
  //     }

  //     if (type) {
  //       console.log('Sorting out', type, type.toString());
  ...
  //   const [isRefreshingItems, setIsRefreshingItems] = React.useState<boolean>(false);
